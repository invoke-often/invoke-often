...
1. Let the Magician clasp his hands upon his Wand, his fingers and thumbs interlaced, crying LAShTAL! \textgreek{ΘΕΛΕΜΑ}! \textgreek{\textDigamma{}IAO\textDigamma{}}! \textgreek{ΑΓΑΠΗ}! \Aumgn{}\editorsnote{\Aumgn{} as written in the 1929 Magick in Theory and Practice may not be correct; this would make the value 93 (MGN) + 400 (U) + 1 (A) = 494, not 100, as in Chapter 7 of Magick in Theory and Practice and Liber Samekh. It must be \textgreek{Α\textDigamma{}ΜΓΝ}, \textit{i.e.} the U must be Digamma (6), not Upsilon (400). The Greek spelling of AUMGN used throughout the 1929 Magick in Theory and Practice is used throughout this text, however, to maintain accuracy with the originals.}!
