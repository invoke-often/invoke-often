{
\raggedbottom
\addchap{Graduum Montis Abiegni}\index{Grade Studies \& Work!descriptions of}
\chapnum{XIII\footnote{The number of Achad=Unity, and the title is perhaps intended to show that all paths of attainment are essential. From the Equinox Vol. 1, No. 3.}}
...
{\raggedleft\textemdash{} \textsc{Liber LXV. Cap. V.} vv. 52-56.\par}
}

\pagebreak

1. \textit{The Probationer.} His duties are laid down in Paper A, Class D. Being \textit{without}, they are vague and general. He receives Liber LXI. and LXV. (Certain Probationers are admitted after six months or more to Ritual XXVIII.)\index{Grade Studies \& Work!Probationer (\grade{0}{0})}
\begin{itemize}
\item At the end of the Probation he passes Ritual DCLXXI., which constitutes him a Neophyte.
\end{itemize}

2. \textit{The Neophyte.} His duties are laid down in Paper B, Class D. He receives Liber VII.\index{Grade Studies \& Work!Neophyte (\grade{1}{10})}
\begin{itemize}
...
3. \textit{The Zelator.} His duties are laid down in Paper C, Class D. He receives Liber CCXX., XXVII., and DCCCXIII.\index{Grade Studies \& Work!Zelator (\grade{2}{9})}
\begin{itemize}
...
4. \textit{The Practicus.} His duties are laid down in Paper D, Class D.\index{Grade Studies \& Work!Practicus (\grade{3}{8})}
\begin{itemize}
...
5. \textit{The Philosophus.} His duties are laid down in Paper E, Class D.\index{Grade Studies \& Work!Philosophus (\grade{4}{7})}
\begin{itemize}
...
6. \textit{The Adeptus Minor.} His duty is laid down in Paper F, Class D.\index{Grade Studies \& Work!Adeptus Minor (\grade{5}{6})}
\begin{itemize}[label={}]
