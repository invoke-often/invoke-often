...
\item Turning to the East make a pentagram (that of Earth)\editorsnote{Usually considered to appropriate for invoking and banishing by changing the direction of the Earth pentagram. See e.g. Israel Regardie's compendium \enquote{The Golden Dawn: The Original Account of the Teachings, Rites, and Ceremonies of the Hermetic Order}.} with the proper weapon (usually the Wand). Say (\textit{i.e.} vibrate) \linebreak[2] I H V H.
