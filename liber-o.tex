\addchap{Liber O vel Manus et Sagitt\ae{}}\index{Grade Studies \& Work!Neophyte (\grade{1}{10})}\index{Grade Studies \& Work!Probationer (\grade{0}{0})}\index{Grade Studies \& Work!Neophyte (\grade{1}{10})}\index{Grade Studies \& Work!Philosophus (\grade{4}{7})}\index{Grade Studies \& Work!Adeptus Major (\grade{6}{5})}
\chapnum{VI\footnote{The title may be read as \enquote{Book of the Hand \& the Arrow}. From the Equinox Vol. 1, No. 2; Magick in Theory and Practice.}}
...
Before entering upon any of these practices, the student should be in good health, and have attained a fair mastery of Asana\index{Asana}, Pranayama\index{Pranayama} and Dharana\index{Dharana}.
...
\addsec*{II. [The Use of 777 \& Qabalistic correspondence essentials]}\index{777!instructions in the use of}
...
1. The Magical Images of the Gods of Egypt should be made thoroughly familiar. This can be done by studying them in any public museum, or in such books as may be accessible to the student. They should then be carefully painted by him, both from the model and from memory.\index{Assumption of God-forms}
...
3. The Vibration of God-names. As a further means of identifying the human consciousness with that pure portion of it which man calls by the name of some God, let him act thus:\index{Vibration of God-names}
...
1. The Rituals\index{Rituals of the Pentagram!Lesser} of the Pentagram and Hexagram must be committed to memory; these are as follows:
...
\item Turning to the East make a pentagram (that of Earth)\editorsnote{Usually considered to appropriate for invoking and banishing by changing the direction of the Earth pentagram. See e.g. Israel Regardie's compendium \enquote{The Golden Dawn: The Original Account of the Teachings, Rites, and Ceremonies of the Hermetic Order}.} with the proper weapon (usually the Wand). Say (\textit{i.e.} vibrate) \linebreak[2] I H V H.\index{Divine names!God-names of the quarters}
\item Turning to the South, the same, but say \linebreak[2] A D N I.\index{Formul\ae{}!ADNI}
...
\item[] Pronounce: Ye-ho-wau\editorsnote{Or vibrate each letter in the name -- \cjRL{y}, \cjRL{h}, \cjRL{w|}, \cjRL{h}.}, Ad\'{o}nai, Eheieh, Agla\index{Formul\ae{}!AGLA}\editorsnote{Or use the full phrase \enquote{Ateh Gibor Le-Olahm Adonai} / \cjRL{'th gbwr l`wlm 'dny}.}.
\item Extending the arms in the form of a Cross say:
\item Before me Raphael;\index{Divine names!Archangels of the quarters}
...
The Pentagrams are traced in the air\editorsnote{As a \enquote{rule of thumb}, banish starting at the element to be banished, moving towards spirit (the top point of the pentagram); invoke starting at spirit and moving towards the element to be invoked.} with the sword or other weapon, the name spoken aloud, and the signs used, as illustrated.\index{Rituals of the Pentagram!Greater}\index{Pentagrams!Elemental}

\subsubsection*{The Pentagrams of Spirit.}\index{Pentagrams!Elemental|(}
...
Invoking & Banishing \\
\end{tabular}
Name: A H I H (Eheieh).\index{Divine names!of the elemental pentagrams|(}
...
The signs of the Portal\index{Signs of!the elemental grades|(}\editorsnote{Of the grade \enquote{Dominus Liminis}.} (\sout{See illustrations}\editorsnote{Illustrations of the signs of the grades are omitted from this volume.}) : Extend the hands in front of you, palms outwards, separate them as if in the act of rending asunder a veil or curtain (actives), and then bring them together as if closing it again and let them fall to the sides (passives).

(The Grade of the \enquote{Portal} is particularly attributed to the element of Spirit; it refers to the Sun; the Paths of \cjRL{s}, \cjRL{n|}, and \cjRL{.s|} are attributed to this degree. \textit{See} \enquote{777} lines 6 and 31 bis.).
...
\subsubsection*{The Pentagrams of Earth.}\index{Pentagrams!Elemental|)}
\begin{center}
\begin{tabular}{ c c }
\pentagram{0.76}[0] & \pentagramreversed{0.76}[0]\\
Invoking & Banishing \\
\end{tabular}
Name: A D N I (Adonai).\index{Formul\ae{}!ADNI}
\end{center}

The signs of \grade{1}{10}. Advance the right foot, stretch out the right hand upwards and forwards, the left hand downwards and backwards, the palms open.\index{Signs of!the elemental grades|)}

(The Grade of \grade{1}{10} is particularly attributed to the element of Earth. For other attributions see \enquote{777} lines 10 and 32 bis).\index{Divine names!of the elemental pentagrams|)}
\subsection*{The Lesser Ritual of the Hexagram.}
%\begin{center}
%\begin{tabular}{ >{\centering}c | c c c c  }
...
This ritual is to be performed after the \enquote{Lesser Ritual of the Pentagram}.\index{Rituals of the Hexagram!Lesser}
...
\item I.N.R.I.\index{Analysis of the Keyword} \\
Yod. Nun. Resh. Yod. \\
Virgo, Isis, Mighty Mother. \\
Scorpio, Apophis, Destroyer. \\
Sol, Osiris, Slain and Risen. \\
Isis, Apophis, Osiris, \textgreek{ΙΑΟ}\index{Formul\ae{}!\textgreek{ΙΑΟ}}.
\item Extend the arms in the form of a cross [\Cross \textendash{} \enquote{The Cross}], and say: \enquote{The Sign of Osiris Slain}.\editorsnote{Example images are in the Equinox Vol. 1, No. 2, and readily available online.}\index{Signs of!L. V. X.}
...
\item \firehexagram{1.2}[-1]\index{Hexagrams!Elemental} With the magical weapon trace the Hexagram of Fire\footnote{This hexagram consists of two equilateral triangles, both apices pointed upwards. Begin at the top of the upper triangle and trace it in a dextro-rotary direction. The top of the lower triangle should coincide with the central point of the upper triangle.} in the East\editorsnote{Dr David Shoemaker suggests in \textit{Living Thelema} that you should match these to the elemental quarters (e.g. as in Lesser Ritual of the Pentagram) rather than following this as written. So here you would make the Hexagram of Air, then turn to the South and make the Hexagram of Fire.} saying: \enquote{ARARITA}\index{Divine names!ARARITA} (\cjRL{'r'ryt'})\footnote{This word consists of the initials of a sentence\footnotemark which means \enquote{One is His Beginning: One is His Individuality: His Permutation is One}.}\footnotetext{This sentence, which may be used in place of the notariqon, is \enquote{Achad Rosh Achdotho Rosh Ichudo Temurato Achad} (\cjRL{'.hd r'/s '.hdwtw r'/s y.hwdw tmwrtw '.hd}) --- \textsc{Editor}.}
\item \earthhexagram{1.2}[-1] \\ Trace the Hexagram of Earth\footnote{This Hexagram has the apex of the lower triangle pointing downwards, and it should be capable of inscription in a circle.} in the South saying: \enquote{ARARITA.}
\item \airhexagram{1.2}[-1] \\ Trace the Hexagram of Air\footnote{This hexagram is like that of Earth; but the bases of the triangles coincide, forming a diamond.} in the West saying: \enquote{ARARITA.}
\item \waterhexagram{1.2}[-1] \\ Trace the Hexagram of Water\footnote{This hexagram has the lower triangle placed above the upper, so that their apices coincide.} in the North saying: \enquote{ARARITA.}
\item Repeat (i-vii)
\item[] The Banishing Ritual is identical, save that the direction of the Hexagrams must be reversed.
\end{enumerate}

\subsection*{The Greater Ritual of the Hexagram.}\index{Hexagrams!Planetary}
{\centering
...
\end{tabular}
\par}
\footnotetext{There are no arrows shown because this is a banishing/invoking of all other 6 planets in order: Saturn, Jupiter, Mars, Venus, Mercury, and finally Luna. Just go down the list! -- \textsc{Editor.}}

To invoke or banish planets or zodiacal signs\editorsnote{The Unicursal Hexagram may be used for invoking and banishing various forces, planetary and elemental. See Frater David R Jones' On the Formul\ae{} of the Unicursal Hexagram for exposition on this. Note that the Unicursal hexagram contains 7 points, including the overlapping centre point. This centre point is attributed to the Sun, giving you only one Hexagram to perform to banish or invoke the Sun in the Greater Ritual of the Hexagram, rather than six.}.

% \subsubsection*{Other planetary signs}
% \begin{center}
...
The Hexagram of Earth alone is used\index{Rituals of the Hexagram!Greater}. Draw the hexagram, beginning from he point which is attributed to the planet you are dealing with. (See \enquote{777} col.lxxxiii). Thus to invoke Jupiter begin from the right hand point of the lower triangle, dextrorotary and complete; then trace the upper triangle from its left hand point and complete.
...
{\centering\raggedbottom
 ...
 \end{tabular}\index{Astrological symbols}
 \footnotetext{Note that these were not in the original Liber O but have been inserted here as a reference. --- \textsc{Editor}.}
 \par
}
...
\addsec*{V. [The Body of Light \& Astral Projection]}\index{Body of Light}
...
4. Let him then cause that imagined figure to rise in the air to a great height above the earth.\index{Astral Projection}
