\addchap{Liber B vel Magi}\index{Grade Studies \& Work!Adeptus Major (\grade{6}{5})}\label{liberb}
\chapnum{I\footnote{I is the number of the Magus in the Tarot. From the Equinox Vol. 1, No. 7}}
...
17. Following which method, it shall be easy for Him to combine that trinity from its elements, and further to combine Sat-Chit-Ananda, and Light, Love, Life, three by three into nine that are one, in which meditation success shall be That which was first adumbrated to Him in the grade of Practicus (which reflecteth Mercury into the lowest world) in Liber XXVII\editorsnote{Liber Trigrammaton, Being the Book of the Trigrams of the Mutations of the Tao with the Yin and the Yang}, \enquote{Here is Nothing under its three Forms.}
