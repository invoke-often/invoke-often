\addchap{Liber Had}
\chapnum{DLV\footnote{H a d fully expanded; thus \cjRL{hh|}, \cjRL{'lp}, \cjRL{dlt}; compare 11 where Nu is fully contracted. From the Equinox Vol. 1, No. 7}}\index{Grade Work!Philosophus (\grade{4}{7})}
