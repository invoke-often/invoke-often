...
\subsection*{Invoking}
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\textwidth,keepaspectratio]{images/invokingpentagrams}}
\end{center}
\subsection*{Banishing}
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\textwidth,keepaspectratio]{images/banishingpentagrams}}
\end{center}
...
\begin{center}
\makebox[\textwidth]{\includegraphics[width=\textwidth,keepaspectratio]{images/averse}}
\end{center}
\addsec*{Elemental Hexagrams}
\subsection*{Invoking}
\begin{center}
\makebox[\textwidth]{\includegraphics[scale=.80,keepaspectratio]{images/invokinghexagrams}}
\end{center}
\subsection*{Banishing}
\begin{center}
\makebox[\textwidth]{\includegraphics[scale=.80,keepaspectratio]{images/banishinghexagrams}}
\end{center}
