...
\NewDocumentCommand{\jupiterhexagram}{
  ...
  \draw (B.center) -- (C.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (A.center) -- (C.center) node[label={[xshift=-20pt,yshift=-30pt]2}]{};
  \else
  \draw (C.center) -- (A.center);
  \fi
  ...
  \draw (AL.center) -- (CL.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (BL.center) -- (CL.center) node[label={[xshift=18pt,yshift=07pt]1}]{} ;
  \else
  \draw (BL.center) -- (CL.center);
  \fi
  \end{scope}
