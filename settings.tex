...
\addtokomafont{title}{\centering\bfseries\rmfamily}
\renewcommand{\raggedchapter}{\centering\rmfamily\bfseries}
\addtokomafont{chapter}{\centering\rmfamily\bfseries\selectfont}
\addtokomafont{section}{\centering\rmfamily\bfseries\fontsize{12.5}{0}\selectfont}
\renewcommand{\raggedchapter}{\centering\rmfamily\bfseries}
\addtokomafont{subsection}{\centering\rmfamily\bfseries\fontsize{11.5}{0}\selectfont}
\addtokomafont{subsubsection}{\centering\rmfamily\bfseries\fontsize{10.5}{0}\selectfont}
...
\usepackage{graphicx}
\newcommand\grade[2]{$#1^{\circ}=#2^{\scalebox{0.45}{$\square$}}$}
...
\renewcommand{\therefore}[1][0pt]{%
  \mathrel{\raisebox{#1}{$\oldtherefore$}}%
}
\newcommand\Argentium{${\mathrm{A}}\mkern2mu{\therefore[1.0pt]{}}\mkern-3mu{\mathrm{A}}\mkern2mu{\therefore[1.0pt]{}}$}
\newcommand\GD{$G\therefore{}D\therefore$}
\newcommand\aethyr{\ae{}thyr}
\newcommand\AEthyr{\AE{}thyr}
\newcommand\Agape{\textgreek{ΑΓΑΠΗ}}
\newcommand\Aumgn{\textgreek{ΑΥΜΓΝ}}
\newcommand\Thelema{\textgreek{ΘΕΛΗΜΑ}}
\newcommand\FIAOF{\textgreek{\textDigamma{}ΙΑΟ\textDigamma{}}}
...
\usepackage{xcolor}
\usepackage[hyperfootnotes=false,unicode=true,linkbordercolor=cyan,psdextra]{hyperref}
\usepackage{starfont}
\usepackage{tikz}
...
\NewDocumentCommand{\earthhexagram}{
  ...
  \draw (A.center) -- (B.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (C.center) -- (B.center) node[label={[xshift=-7pt,yshift=13pt]1}]{};
  \else
  \draw (B.center) -- (C.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (C.center) -- (A.center) node[label={[xshift=5pt,yshift=12pt]1}]{};
  \else
  \draw (C.center) -- (A.center);
  \fi
...
\NewDocumentCommand{\marshexagram}{
  ...
  \node(C) at (#1 / 2, {(#1 * .86)}) {};
  \ifnum #2=-1
  \draw[postaction={decorate}] (B.center) -- (A.center) node[label={[xshift=06pt,yshift=12pt]1}]{};
  \else
  \draw (A.center) -- (B.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (B.center) -- (C.center) node[label={[xshift=15pt,yshift=-30pt]2}]{};
  \else
  \draw (B.center) -- (C.center);
  \fi
  \draw (C.center) -- (A.center);
  ...
  \node(CL) at (#1 / 2, {#1 - (#1 * .86) - 0.5}) {};
  \ifnum #2=-1
  \draw[postaction={decorate}] (AL.center) -- (BL.center) node[label={[xshift=-10pt,yshift=-34pt]2}]{};
  \else
  \draw (AL.center) -- (BL.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (AL.center) -- (CL.center) node[label={[xshift=-17pt,yshift=05pt]1}]{};
  \else
  \draw (AL.center) -- (CL.center);
  \fi
  \draw (BL.center) -- (CL.center);
...
\NewDocumentCommand{\jupiterhexagram}{
  ...
  \node(C) at (#1 / 2, {(#1 * .86)}) {};
  \ifnum #2=1
  \draw[postaction={decorate}] (A.center) -- (B.center) node[label={[xshift=-26pt,yshift=-14pt]2}]{};
  \else
  \draw (A.center) -- (B.center);
  \fi
  \draw (B.center) -- (C.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (A.center) -- (C.center) node[label={[xshift=-16pt,yshift=-28pt]2}]{};
  \else
  \draw (C.center) -- (A.center);
  \fi
  ...
  \node(CL) at (#1 / 2, {#1 - (#1 * .86) - 0.5}) {};
  \ifnum #2=1
  \draw[postaction={decorate}] (BL.center) -- (AL.center) node[label={[xshift=08pt,yshift=-07pt]1}]{};
  \else
  \draw (AL.center) -- (BL.center);
  \fi
  \draw (AL.center) -- (CL.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (BL.center) -- (CL.center) node[label={[xshift=16pt,yshift=07pt]1}]{} ;
  \else
  \draw (BL.center) -- (CL.center);
  \fi
  \end{scope}
...
\NewDocumentCommand{\venushexagram}{
  ...
  \node(C) at (#1 / 2, {(#1 * .86)}) {};
  \ifnum #2=-1
  \draw[postaction={decorate}] (B.center) -- (A.center) node[label={[xshift=26pt,yshift=-17pt]1}]{} ;
  \else
  \draw (A.center) -- (B.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (B.center) -- (C.center) node[label={[xshift=18pt,yshift=-30pt]1}]{} ;
  \else
  \draw (B.center) -- (C.center);
  \fi
  \draw (C.center) -- (A.center);
  ...
  \node(CL) at (#1 / 2, {#1 - (#1 * .86) - 0.5}) {};
  \ifnum #2=-1
  \draw[postaction={decorate}] (AL.center) -- (BL.center) node[label={[xshift=-24pt,yshift=-03pt]2}]{} ;
  \else
  \draw (AL.center) -- (BL.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (AL.center) -- (CL.center) node[label={[xshift=-18pt,yshift=8pt]2}]{} ;
  \else
  \draw (AL.center) -- (CL.center);
  \fi
  \draw (BL.center) -- (CL.center);
...
\NewDocumentCommand{\mercuryhexagram}{
  ...
  \node(C) at (#1 / 2, {(#1 * .86)}) {};
  \ifnum #2=1
  \draw[postaction={decorate}]  (A.center) -- (B.center) node[label={[xshift=-23pt,yshift=-17pt]1}]{};
  \else
  \draw (A.center) -- (B.center);
  \fi
  \draw (B.center) -- (C.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (A.center) -- (C.center) node[label={[xshift=-17pt,yshift=-28pt]1}]{};
  \else
  \draw (C.center) -- (A.center);
  \fi
  ...
  \node(CL) at (#1 / 2, {#1 - (#1 * .86) - 0.5}) {};
  \ifnum #2=1
  \draw[postaction={decorate}] (BL.center) -- (AL.center) node[label={[xshift=08pt,yshift=-04pt]2}]{};
  \else
  \draw (AL.center) -- (BL.center);
  \fi
  \draw (AL.center) -- (CL.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (BL.center) -- (CL.center) node[label={[xshift=18pt,yshift=05pt]2}]{};
  \else
  \draw (BL.center) -- (CL.center);
  \fi
  \end{scope}
...
\NewDocumentCommand{\moonhexagram}{
  ...
  \draw (A.center) -- (B.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (C.center) -- (B.center) node[label={[xshift=-00pt,yshift=-0pt]2}]{};
  \else
  \draw (B.center) -- (C.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (C.center) -- (A.center) node[label={[xshift=-00pt,yshift=-0pt]2}]{};
  \else
  \draw (C.center) -- (A.center);
  \fi
  ...
  \draw (AL.center) -- (BL.center);
  \ifnum #2=-1
  \draw[postaction={decorate}] (CL.center) -- (AL.center) node[label={[xshift=-00pt,yshift=-20pt]1}]{};
  \else
  \draw (AL.center) -- (CL.center);
  \fi
  \ifnum #2=1
  \draw[postaction={decorate}] (CL.center) -- (BL.center) node[label={[xshift=-00pt,yshift=-20pt]1}]{};
  \else
  \draw (BL.center) -- (CL.center);
  \fi
  \end{scope}
...
\NewDocumentCommand{\unicursalhexagramplain}{
  m % size
}{
  \begin{tikzpicture}
    \draw[black,line width=.2mm] (0,1.2 * #1) -- (-1.15 * #1,-.65 * #1) -- (1.15 * #1,.65 * #1) -- (0,-1.2 * #1) -- (-1.15 * #1,.65 * #1) -- (1.15 * #1,-.65 * #1) -- (0, 1.2 * #1);
  \end{tikzpicture}
}
