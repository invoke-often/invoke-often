...
1. Let him greet the Sun at dawn, facing East, giving the sign of his grade\editorsnote{There are several possibilities for this if you are not a member of the \Argentium{}. One example, noted in Lon Milo DuQuette's \textit{The Magick of Aleister Crowley}, is to use the four L.V.X. signs at dawn (i.e. the $5^{\circ}=6^{\square}$ signs); the Fire $4^{\circ}=7^{\square}$ sign at noon; the Water $3^{\circ}=8^{\square}$ sign at dusk; and the Air $2^{\circ}=9^{\square}$ sign at midnight. Another possibility is to utilise the signs of the enterer and silence, of $0^{\circ}=0^{\square}$}. And let him say in a loud voice:
