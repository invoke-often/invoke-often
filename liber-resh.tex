...
\chapnum{CC\footnote{The number of \cjRL{r|} the Sun. From the Equinox Vol. 1, No. 7; Magick in Theory and Practice.}}
...
1. Let him greet the Sun at dawn, facing East, giving the sign of his grade\editorsnote{There are several possibilities for this if you are not a member of the \Argentium{}. One example, noted in Lon Milo DuQuette's \textit{The Magick of Aleister Crowley}, is to use the four L.V.X. signs at dawn (i.e. the $5^{\circ}=6^{\square}$ signs); the Fire $4^{\circ}=7^{\square}$ sign at noon; the Air $2^{\circ}=9^{\square}$ sign at dusk; and the Water $3^{\circ}=8^{\square}$ sign at midnight\footnotemark. Another possibility is to utilise the signs of the enterer and silence, of $0^{\circ}=0^{\square}$}\footnotetext{Consider that in this scheme, at dawn you greet the return of the Sun with the 'Light in Extension' (L.V.X.) signs; at noon with an upward pointing triangle, thus pointing at the triumphing sun; at sunset with a gesture level with the horizon; and at midnight with a downward pointing triangle, thus pointing at the hidden sun. --- \textsc{Editor}.}. And let him say in a loud voice:
...
5. And after each of these invocations thou shalt give the sign of silence, and afterwards thou shalt perform the adoration that is taught thee by thy Superior\editorsnote{If you do not have a superior, \textit{i.e.} you are a solo practitioner, there are adorations available online you can find, but you can also compose your own, use the Stele of Revealing, or use the Stele of Revealing adoration in Liber AL -- see III. 38-39. I like to use a portion of David Bowie's song \enquote{Starman}\footnotemark}\footnotetext{\enquote{There's a starman waiting in the sky; he'd like to come and meet us, but he thinks he'd blow our minds. There's a starman waiting in the sky; he told us not to blow it `cause he knows it's all worthwhile. He told me, \enquote{Let the children lose it, let the children use it, let all the children boogie.}} --- \textsc{Editor.}} . And then do thou compose Thyself to holy meditation.
