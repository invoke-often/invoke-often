\addchap{The Star Ruby}\index{Rituals of the Pentagram!The Star Ruby}\index{Grade Studies \& Work!Probationer (\grade{0}{0})}
...
\begin{quoting}[indentfirst=false]
\textgreek{\textsc{Ιαω}}\footnote{\enquote{IAO}. See Magick, Chapter V.}\index{Formul\ae{}!\textgreek{ΙΑΟ}}
\end{quoting}
...
\begin{quoting}[indentfirst=false]
\textgreek{\textsc{Χαοσ}}\footnote{\enquote{Chaos}; in another text \enquote{roar Therion} which may be used instead.}\index{Chaos}
\end{quoting}

Retire thine hand in the sign of Hoor pa kraat\footnote{Later \enquote{Hoor-paar-Kraat}}. Go round to the North and repeat; but scream \begin{quoting}[indentfirst=false]\textgreek{\textsc{\GreekBabalon}}\index{Babalon}\footnote{\enquote{Babalon}; in another text \enquote{say Nuit} which may be used instead.} \end{quoting}
...
Completing the circle widdershins, retire to the centre, and raise thy voice in the Paian, with these words, with the signs of N.\nolinebreak{} O.\nolinebreak{} X.\nolinebreak{}\editorsnote{See Liber V vel Reguli.}\index{Signs of!N. O. X.}  \begin{quoting}[indentfirst=false]\textgreek{\textsc{Ιω Παν}}\footnote{\enquote{Io Pan!}: A salute to Pan}\end{quoting}
