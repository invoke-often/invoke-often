\addchap{Liber Astart\'{e} vel Berylli}\index{Grade Studies \& Work!Philosophus (\grade{4}{7})}\index{Grade Studies \& Work!Probationer (\grade{0}{0})}

\chapnum{CLXXV\footnote{The number of Venus or Astarte. From the Equinox Vol. 1, No. 10; Magick in Theory and Practice.}}
...
And lest thy twine slip, here is a little cord that wrappeth tightly round and round all, even the Mantram or Continuous Prayer\index{Mantras!in the method of devotion}.
...
40. \textit{Concerning the value of this particular form of Union or Samadhi.} All Samadhi\index{Samadhi|(} is defined as the ecstatic union of a subject and object in consciousness, with the result that a third thing arises which partakes in no way of the nature of the two.
...
And they are in any case more likely to lead to madness than to Samadhi\index{Samadhi|)}. He indeed who purposeth them is already mad.
...
48. \textit{Concerning the Holy Guardian Angel\index{Holy Guardian Angel}.} Do thou in no wise confuse this invocation with that.

49. \textit{The Benediction.} And so may the love that passeth all Understanding keep your hearts and minds through \textgreek{\textsc{Ιαω Αδοναι Σαβαω}}, through \textsc{Babalon}\index{Babalon} of the City of the Pyramids\index{City of the Pyramids}, and through Astart\'{e}, the Starry One green-girdled, in the name \textsc{Ararita}. Amen.
