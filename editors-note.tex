...
\item Liber VIII. \textit{See}{}\-\ CCCCXVIII\footnote{The instruction in the 8th \AEthyr{} pertains to Class D, \textit{i.e.} it is an Official Ritual, and the same remarks apply to the account of the proper method of invoking \AEthyr{}s given in the 18th \AEthyr.\footnotemark}\footnotetext{This second edition of \enquote{Invoke Often!} corrects the missing instructions in the 18th \AEthyr{}.}
