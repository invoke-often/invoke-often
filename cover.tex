...
\bookcovercomponent{tikz}{front}{
  \fill[black] (part.south west) -- (part.north west) -- ([xshift=0.3cm] part.north west) -- ([xshift=0.3cm] part.south west) -- cycle;
}
\bookcovercomponent{tikz}{back}{
  \fill[black] (part.south east) -- (part.north east) -- ([xshift=-0.3cm] part.north east) -- ([xshift=-0.3cm] part.south east) -- cycle;
}
