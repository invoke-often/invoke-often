...
\bookcovercomponent{tikz}{front}{
  \fill[black] (part.south west) -- (part.north west) -- ([xshift=0.5cm] part.north west) -- ([xshift=0.5cm] part.south west) -- cycle;
}
\bookcovercomponent{tikz}{back}{
  \fill[black] (part.south east) -- (part.north east) -- ([xshift=-0.5cm] part.north east) -- ([xshift=-0.5cm] part.south east) -- cycle;
}
