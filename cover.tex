...
% Top front Border
\bookcovercomponent{tikz}{front}{
  \fill[black] (part.north east) -- (part.north west) -- ([yshift=-0.4cm] part.north west) -- ([yshift=-0.4cm] part.north east) -- cycle;
}
% Bottom front Border
\bookcovercomponent{tikz}{front}{
  \fill[black] (part.south east) -- (part.south west) -- ([yshift=0.4cm] part.south west) -- ([yshift=0.4cm] part.south east) -- cycle;
}
% Edge Border front
\bookcovercomponent{tikz}{front}{
